...
# -= Resources =-
#
#SBATCH --job-name=ghrhr_iqtree_boostrap_modelfinder
...
#SBATCH --time=7-0:0
#SBATCH --output=%j-ghrhr_iqtree_boostrap_modelfinder.out
#SBATCH --mail-type=ALL
#SBATCH --mail-user=omerfatihkonar@sabanciuniv.edu
#SBATCH --chdir=/cta/users/ofkonar/work/results/trees/ghrhr_iqtree/

module load iq-tree-2.0.6-gcc-9.2.0-fufn5ou

iqtree2 -s /cta/users/ofkonar/work/resources/class_B1/canonical/ghrhr_filtered_fastas_blast_msa.fasta -B 2000 --nmax 2100 -alrt 2000 -nm 2100 -T AUTO --threads-max 24 --prefix ghrhr_iqtree_boostrap_modelfinder