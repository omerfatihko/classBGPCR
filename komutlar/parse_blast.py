...
#read results
results_csv = pd.read_csv("/cta/users/ofkonar/work/results/gcgr/gcgr_blast_results_csv.csv", header = None, names = colnames)
...
filtered_fastas=open('/cta/users/ofkonar/work/fasta/gcgr_filtered_fastas_5th.fasta','w')
