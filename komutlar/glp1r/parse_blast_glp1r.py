...
#read results
results_csv = pd.read_csv("/cta/users/ofkonar/work/results/glp1r/glp1r_blast_results_csv.csv", header = None, names = colnames)
...
#get all protein sequences until 5th human sequence (5th human seq will act as outgroup)
...
filtered_fastas=open('/cta/users/ofkonar/work/fasta/glp1r_filtered_fastas.fasta','w')
