...
#SBATCH --time=120
#SBATCH --output=%j-blast_glp1r.out
#SBATCH --mail-type=ALL
#SBATCH --mail-user=omerfatihkonar@sabanciuniv.edu
module load blast-plus-2.9.0-gcc-9.2.0-k73hoo5
blastp -query /cta/users/ofkonar/work/fasta/glp1r_human.fasta -db /cta/users/ofkonar/work/uniprot_database/uniprot_db -out /cta/users/ofkonar/work/results/glp1r/glp1r_blast_results_csv.csv -outfmt "10 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore sacc stitle"