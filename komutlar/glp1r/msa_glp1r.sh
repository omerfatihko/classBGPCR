...
#SBATCH --time=120
#SBATCH --output=%j-msa_glp1r.out
#SBATCH --mail-type=ALL
#SBATCH --mail-user=omerfatihkonar@sabanciuniv.edu

module load mafft-7.407-gcc-9.2.0-fww6zrx

einsi /cta/users/ofkonar/work/fasta/glp1r_filtered_fastas.fasta > /cta/users/ofkonar/work/results/glp1r/glp1r_aligned.fasta