...
# -= Resources =-
#
#SBATCH --job-name=gcgr_gipr_parse_orthologs
...
#SBATCH --time=1-0:0
#SBATCH --output=%j-gcgr_gipr_parse_orthologs.out
...
python /cta/users/ofkonar/work/komutlar/parse_gcgr_gigr_orthologs.py