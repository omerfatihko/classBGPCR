...
#read results
results_csv = pd.read_csv("/cta/users/ofkonar/work/results/gcgr_gipr.csv", header = None, names = colnames)
...
filtered_fastas=open('/cta/users/ofkonar/work/fasta/gcgr_gipr_orthologs.fasta','w')
