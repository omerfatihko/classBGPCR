...
colnames = ["OX", "stitle", "sseqid"]

#read results
results_csv = pd.read_csv("/cta/users/ofkonar/work/results/gcgr/gcgr_orthologs.csv", header = None, names = colnames)
...
filtered_fastas=open('/cta/users/ofkonar/work/fasta/gcgr_orthologs.fasta','w')
