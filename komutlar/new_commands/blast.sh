...
#SBATCH --time=120
#SBATCH --output=%j-blast_vipr2.out
#SBATCH --mail-type=ALL
#SBATCH --mail-user=omerfatihkonar@sabanciuniv.edu
module load blast-plus-2.9.0-gcc-9.2.0-k73hoo5
blastp -query /cta/users/ofkonar/work/resources/fasta/secretin_subfamily/vipr2_human.fasta -db /cta/users/ofkonar/work/resources/uniprot_database/uniprot_db -out /cta/users/ofkonar/work/results/secretin_subfamily/vipr2/vipr2_blast_results.csv -outfmt "10 qseqid sseqid pident length mismatch gapopen qstart qend sstart send evalue bitscore sacc stitle"