...
# -= Resources =-
#
#SBATCH --job-name=msa_gcgr_glp1r_orthologs
...
#SBATCH --time=120
#SBATCH --output=%j-msa_gcgr_glp1r_orthologs.out
#SBATCH --mail-type=ALL
#SBATCH --mail-user=omerfatihkonar@sabanciuniv.edu

module load mafft-7.407-gcc-9.2.0-fww6zrx

einsi /cta/users/ofkonar/work/resources/fasta/gcgr_glp1r_orthologs.fasta > /cta/users/ofkonar/work/resources/fasta/gcgr_glp1r_orthologs_al.fasta