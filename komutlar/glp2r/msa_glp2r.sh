...
#SBATCH --time=120
#SBATCH --output=%j-msa_glp2r.out
#SBATCH --mail-type=ALL
#SBATCH --mail-user=omerfatihkonar@sabanciuniv.edu

module load mafft-7.407-gcc-9.2.0-fww6zrx

einsi /cta/users/ofkonar/work/fasta/glp2r_filtered_fastas.fasta > /cta/users/ofkonar/work/results/glp2r/glp2r_aligned.fasta