...
#read results
results_csv = pd.read_csv("/cta/users/ofkonar/work/results/glp2r/glp2r_blast_results_csv.csv", header = None, names = colnames)
...
filtered_fastas=open('/cta/users/ofkonar/work/fasta/glp2r_filtered_fastas.fasta','w')
