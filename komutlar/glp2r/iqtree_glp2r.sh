...
# -= Resources =-
#
#SBATCH --job-name=glp2r_iqtree_boostrap_modelfinder
...
#SBATCH --output=%j-glp2r_iqtree_boostrap_modelfinder_1.out
#SBATCH --chdir=/cta/users/ofkonar/work/results/glp2r/glp2r_iqtree/

module load iq-tree-2.0.6-gcc-9.2.0-fufn5ou

iqtree2 -s /cta/users/ofkonar/work/results/glp2r/glp2r_aligned.fasta -B 1000 -alrt 1000 -T AUTO --threads-max 24 --prefix glp2r_iqtree_boostrap_modelfinder_1