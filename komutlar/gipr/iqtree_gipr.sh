...
# -= Resources =-
#
#SBATCH --job-name=gipr_iqtree_boostrap_modelfinder
...
#SBATCH --time=1-0:0
#SBATCH --output=%j-gipr_iqtree_boostrap_modelfinder_2.out
#SBATCH --mail-type=ALL
#SBATCH --mail-user=omerfatihkonar@sabanciuniv.edu
#SBATCH --chdir=/cta/users/ofkonar/work/results/gipr/gipr_iqtree_2/

module load iq-tree-2.0.6-gcc-9.2.0-fufn5ou

iqtree2 -s /cta/users/ofkonar/work/results/gipr/gipr_aligned_5th.fasta -B 1000 -alrt 1000 -T AUTO --threads-max 24 --prefix gipr_iqtree_boostrap_modelfinder_2 