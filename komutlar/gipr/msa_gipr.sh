...
#SBATCH --time=120
#SBATCH --output=%j-msa_gipr_5th.out
#SBATCH --mail-type=ALL
#SBATCH --mail-user=omerfatihkonar@sabanciuniv.edu

module load mafft-7.407-gcc-9.2.0-fww6zrx

einsi /cta/users/ofkonar/work/fasta/gipr_filtered_fastas_5th.fasta > /cta/users/ofkonar/work/results/gipr/gipr_aligned_5th.fasta