...
with open("/cta/users/ofkonar/work/fasta/gcgr_gipr_orthologs_aligned_pruned.fasta", 'r') as file:
	counter = 0
	temp = ""
	for line in file:
		if line[0] == '>':
...
filtered_fastas=open('/cta/users/ofkonar/work/fasta/gcgr_split_pruned.fasta','w')
...
#open a file to write selected sequences
filtered_fastas=open('/cta/users/ofkonar/work/fasta/gipr_split_pruned.fasta','w')
